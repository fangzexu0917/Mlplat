---
layout: docs title: Events description: The Events API of Bootstrap Table. group: api toc: true
---
...
- **Detail:**
  ...
  Fires when click the detail icon to expand the detail view, the parameters contain:
    ...
    * `$detail`: the DOM element of the detail `div` after current `tr` element, you can use jQuery methods to custom
      the detail views.
