/**
 * @file 地图绘制数据并抛出
 * @author zhaiwanli(zhaiwanli@baidu.com)
 * @time 16/12/5
 */

define(['exports', 'echarts'], function (exports, echarts) {
    // 地理数据，用于绘制地图，调整了省份名字的坐标，更美观
    /* eslint-disable */
    var geoData = {
        ...
        "features": [{
            ...
            "properties": {"cp": [114, 23.1], "name": "香港", "childNum": 5}
        }, {
            "id": "820000",
            "geometry": {"type": "Polygon", "coordinates": ["@@áw{Îr"], "encodeOffsets": [[116285, 22746]]},
            "properties": {"cp": [114, 22.36], "name": "澳门", "childNum": 1}
        }],
        "UTF8Encoding": true
    };
    /* eslint-enable */
    ...
    // 用数据注册地图，必须在map初始化之前
    echarts.registerMap('c_china', geoData);
