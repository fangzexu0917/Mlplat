...
type
JestMatcher = (actual: any, expected: any) => JestMatcherResult;
...
void,
  toHaveState
:
((stateKey: string, stateValue ? : any
) =>
void
) &
((state: Object) => void),
  toHaveStyle
:
((styleKey: string, styleValue ? : any
) =>
void
) &
((style: Object) => void),
...
JestExpectType = {
   ...
   *
   */
  toHaveProperty(propPath: string, value ? : any
):
void,
  /**
...
void,
   ...
   * Alias: .toThrowError
   */
  toThrow(message ? : string | Error | Class < Error > | RegExp)
:
void,
  toThrowError(message ? : string | Error | Class < Error > | RegExp)
:
void,
  /**
...
declare
var xdescribe: typeof describe;
/** A focused group of tests */
declare
var fdescribe: typeof describe;
...
type
JestPrettyFormatIndent = string => string;
type
JestPrettyFormatRefs = Array < any >;
type
JestPrettyFormatPrint = any => string;
type
JestPrettyFormatStringOrNull = string | null;
...
type
JestPrettyFormatPlugins = Array < JestPrettyFormatPlugin >;
...
function spyOn(value: mixed, method: string): Object;

/** Holds all functions related to manipulating test runner */
declare
var jest: JestObjectType;
